...
<template>
  <div>
    ...
    <el-table size="small" :data="listData" highlight-current-row v-loading="loading" border element-loading-text="拼命加载中" style="width: 100%;">
      ...
      <el-table-column sortable prop="phone" label="手机号" width="100">
      </el-table-column>
      <el-table-column sortable prop="email" label="邮箱" width="180">
      </el-table-column>
      <el-table-column sortable prop="address" label="地址" width="150">
      </el-table-column>
      <el-table-column sortable prop="userName" label="登录账号" width="150">
      </el-table-column>
      <el-table-column sortable prop="groupName" label="所属组织" width="150">
      </el-table-column>
    ...
    <el-dialog :title="title" :visible.sync="editFormVisible" width="60%" @click="closeDialog">
      <el-form inline label-width="120px" :model="editForm" :rules="rules" ref="editForm">
        ...
        <el-form-item label="地址" prop="address">
          <el-input size="small" v-model="editForm.address" auto-complete="off" placeholder="请输入地址"></el-input>
        </el-form-item>
        <el-form-item label="登录账号" prop="userName">
          <el-input size="small" v-model="editForm.userName" auto-complete="off" placeholder="请输入登录账号"></el-input>
        </el-form-item>
